# 4th Generation Decorating – Custom WordPress Theme

This is a complete wordpress theme for the painting and decorating company 4th Gen Decorating.
...
👉 [Visit the Live Website](www.4thgendecorating.com)

* 🖌️ Showcase the company’s services
* 🏡 Display examples of completed work
* 📷 Provide a user-friendly gallery experience

## Tech Stack ##
* 🖥️ WordPress – CMS platform
* 📝 PHP – Theme logic and template development
* 🎨 CSS3 – Styling and layout
* ⚡ JavaScript (ES6+) – Interactivity
* 📄 HTML5 – Theme structure

## Features ##
* 🎨 Custom WordPress Theme – Tailored to the business’s branding and requirements
* 🔧 Advanced Custom Fields (Free) – Enables flexible, client-managed content
* 🖼️ FooGallery Integration – Showcases work with an easy-to-manage gallery system
